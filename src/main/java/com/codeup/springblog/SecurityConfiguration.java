...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(12); // default salt is 10
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/", "/roll-dice", "/roll-dice-result",
                        "/posts", "/posts/view", "/posts/show", "/posts/{id}", "/posts/json", "/posts/json/{id}") // anyone can see these pages
                .permitAll()
